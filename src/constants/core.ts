...
export const GameList: GameConfig[] = [
  {
    id: 'hk4e',
    name: '原神',
    pages: ['home', 'files', 'version-compare', 'predownload', 'usm-history'],
  ...
  },
  {
    id: 'bh3',
    name: '崩坏3',
    pages: ['home', 'files', 'version-compare', 'predownload'],
...
export const PageList: AppPage[] = [
  ...
  { id: 'predownload', name: '预下载', component: () => import('@/views/pages/Predownload.vue') },
